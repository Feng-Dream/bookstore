...
<div id="top_div">
    <c:choose>
        <c:when test="${null != currentUser}">
            ...
            <p class="right"><c:if test="${currentUser.admin == true}"><a href="input/manager/console">后台管理</a> </c:if><c:if test="${currentUser.admin == false}"><a href="shoppingCar/myShoppingcar">我的购物车</a> | <a href="input/show/console">我的订单</a></c:if> | <a href="user/doLogout">退出系统</a> | <a href="input/index">网站首页</a></p>
        </c:when>
        <c:otherwise>
